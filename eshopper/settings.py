...
SECRET_KEY = 'django-insecure-yyj7wfjfu!yqa30k9=34ceo22^9s&9)n7)b)35i(glrkg3(i%+'
...
# Notlar:
# En son pasword reset html özelleştirmesinde kaldın, connection.html yide bakıyordun en son

# Lightening_env/lib/site-packges/allauth/socialaccount/templates/socialaccount
# Lightening_env/lib/site-packges/allauth/templates/account
