...
class CustomUserCreationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for name, field in self.fields.items():
            ...
            #     attrs={"placeholder": "İsim Giriniz", "class": "form-control form-control-lg"})
            # self.fields["last_name"].widget = forms.TextInput(
            #     attrs={"placeholder": "Soyisim Giriniz", "class": "form-control form-control-lg"})
...
class UserLoginForm(LoginForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['login'].widget = forms.TextInput(attrs={'class': 'form-control mt-2 mb-2 form-control-lg', 'placeholder': 'Kullanıcı Adı veya E-posta Adresinizi Giriniz',})
        self.fields['password'].widget = forms.PasswordInput(attrs={'class': 'form-control mb-2 form-control-lg input','placeholder': 'Parolanızı Giriniz','id': 'password',})
        self.fields['remember'] = forms.BooleanField(required=False)
...
class AddressForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["addressTitle"].widget = forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Bölge Giriniz"})
